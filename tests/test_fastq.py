...
class FastqReaderTestCase(unittest.TestCase):
    ...
    def test_file_closed_on_completion(self):
        ...
        self.assertTrue(fh.closed, "File should be closed after iteration compeletes")
    ...
    def test_file_closed_on_header_error(self):
        ...
        self.assertTrue(fh.closed, "File should be closed if exception occurs due to invalid header")
    ...
    def test_file_closed_on_line3_error(self):
        ...
        with fastqReader(fh) as reader:
            with self.assertRaises(fastqFormatError):
                for _ in reader:
                    pass
        self.assertTrue(fh.closed, "File should be closed if exception occurs due to invalid line3")
